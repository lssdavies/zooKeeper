//qureys selectors for forms on index page
const $animalForm = document.querySelector('#animal-form');
const $zookeeperForm = document.querySelector('#zookeeper-form');

//function to process new animal data
...
//function to process new zookeeper data
...
//event listners for submnit buttons and calls the appropriate function
